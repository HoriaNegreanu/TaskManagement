...
namespace TaskManagement.Controllers
{
    public class CommentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Comment.Include(c => c.TaskItem);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Message,Author,TaskItemID")] Comment comment)
        {
            if (id != comment.ID)
            {
                return NotFound();
